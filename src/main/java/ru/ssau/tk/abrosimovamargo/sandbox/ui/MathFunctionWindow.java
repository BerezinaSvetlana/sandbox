...
import ru.ssau.tk.abrosimovamargo.sandbox.functions.*;
...
public class MathFunctionWindow extends JDialog {
    ...
    public void fillMap() {
        nameFunctionMap.put("Округление дроби в большую сторону", new CeilFunction());
        ...
        nameFunctionMap.put("Арксинус", new AsinFunction());
