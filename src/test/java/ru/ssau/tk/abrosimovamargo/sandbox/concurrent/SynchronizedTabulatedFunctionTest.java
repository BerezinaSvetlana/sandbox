...
public class SynchronizedTabulatedFunctionTest {
    ...
    public void testSetY() {
        ...
        assertEquals(checkFunction.getY(0), 5.0);
        checkFunction.setY(1, 3);
        assertEquals(checkFunction.getY(1), 3.0);
        checkFunction.setY(2, 7);
        assertEquals(checkFunction.getY(2), 7.0);
    }
    ...
    public void testApply() {
        double delta = 0.1;
        assertEquals(getSynchronizedList().apply(1), 2.1, delta);
        assertEquals(getSynchronizedList().apply(2), 2.3, delta);
        assertEquals(getSynchronizedList().apply(3), 2.2, delta);
